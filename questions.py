questions = [
    {
        ...
        "answers": ["Caribbean Vacations", "Caribbean Cafe", "Caribbean Notifications", "Caribbean Upgrade"],
    ...
    },
    {
        ...
        "answers": ["Extra Legroom", "Extra Food", "Larger Plane",	"Free first class upgrade"],
